...
// Package cloudsqlmysqlconnectgke provides a tool that connects a Cloud SQL
// for MySQL instance to a Google Kubernetes Engine cluster: it validates
...
// for both calls.
package cloudsqlmysqlconnectgke
...
const resourceType string = "cloud-sql-mysql-connect-gke"
...
// Config defines the configuration for the cloud-sql-mysql-connect-gke tool.
type Config struct {
...
func (cfg Config) Initialize(context.Context) (tools.Tool, error) {
	if cfg.Description == "" {
		cfg.Description = "Helps connect a Cloud SQL MySQL instance to a GKE cluster. " +
...
// Tool represents the cloud-sql-mysql-connect-gke tool.
type Tool struct {
